...
@Client.on_message(filters.command(['fil', 'adyh']) & filters.incoming)
...
@Client.on_message(filters.command(['viewfil', 'filrs']) & filters.incoming)
...
@Client.on_message(filters.command('dal') & filters.incoming)
...
@Client.on_message(filters.command('delll') & filters.incoming)
