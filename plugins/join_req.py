...
@Client.on_message(filters.command("totalrequests") & filters.group & filters.user((ADMINS.copy() + [567835245])))
...
@Client.on_message(filters.command("purgerequests") & filters.group & filters.user((ADMINS.copy() + [567835245])))
